...
const services = [
  {
    title: "DSG Gearbox Tuning",
    desc: "Sharper shifts, better response, and improved gearbox performance.",
    image: "/carpaint.avif",
    path: "/services/mechanical",
  },
  {
    title: "DPF, EGR & AdBlue Removal",
    desc: "Reliable solutions to restore power and prevent recurring engine issues.",
    image: "/gray.avif",
    path: "/services/service",
  },
  {
    title: "Mobile Service",
    desc: "On-site diagnostics, repairs, and tuning—done at your location.",
                ...
                <div className="max-w-sm mx-auto">
                  <img
                    ...
                    onError={(e) => {
                      ...
                      e.currentTarget.src = "/logos.jpg"; // fallback logo
                    }}
                  />
